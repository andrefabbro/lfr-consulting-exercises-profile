...
/**
 * Provides the remote service interface for GeneralProfile. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author andrefabbro
 * @see GeneralProfileServiceUtil
...
public interface GeneralProfileService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GeneralProfileServiceUtil} to access the general profile remote service. Add custom service methods to {@link com.amf.user.profile.service.impl.GeneralProfileServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
