...
package com.amf.user.profile.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			GeneralProfileLocalServiceUtil.clearService();

			GeneralProfileServiceUtil.clearService();
			MovieInterestLocalServiceUtil.clearService();

			MovieInterestServiceUtil.clearService();
		}
	}
}